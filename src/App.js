...
function App() {
  ...
  if (screen === 'welcome') return <Welcome onGetStarted={() => setScreen('signup')} />;
  if (screen === 'login') return <Login onLogin={handleLogin} onSwitchToSignup={() => setScreen('signup')} />;
  if (screen === 'signup') return <Signup onSignup={handleSignup} onSwitchToLogin={() => setScreen('login')} />;
